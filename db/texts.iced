...
exports.update = (elementId, text, fn) =>
  @client.hset "texts:#{elementId}", "text", text

exports.findById = (elementId, fn) =>
  @client.hgetall "texts:#{elementId}", fn

exports.remove = (elementId, fn) =>
...
exports.getProjectTodos = (pid, count, fn) =>
...
exports.resolveTodo = (elementId, fn) =>
  @db.texts.findById elementId, (err, text) =>
    if not err and text
      @client.lrem "projects:#{text.pid}:todo", 0, elementId
...
exports.reopenTodo = (elementId, fn) =>
  @db.texts.findById elementId, (err, text) =>
    if not err and text
      @client.lpush "projects:#{text.pid}:todo", elementId
