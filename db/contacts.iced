...
exports.isContact = (id, cid, pid, fn) =>
  #Get user projects
...
exports.recalculate = (id, contacts, pid, fn) =>
  for cid in contacts
...
exports.deleteContacts = (pid, array, index, fn) =>
