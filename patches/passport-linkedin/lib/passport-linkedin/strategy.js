...
function Strategy(options, verify) {
  options = options || {};
  options.requestTokenURL = options.requestTokenURL || 'https://api.linkedin.com/uas/oauth/requestToken?scope=r_basicprofile+r_emailaddress';
...
Strategy.prototype.userProfile = function(token, tokenSecret, params, done) {
  var me = this;
  this._oauth.get('https://api.linkedin.com/v1/people/~:(id,first-name,last-name,email-address)?format=json', token, tokenSecret, function (err, body, res) {
    ...
    try {
      ...
      me._oauth.get('https://api.linkedin.com/v1/people/~/email-address', token, tokenSecret, function (err, body, res) {
