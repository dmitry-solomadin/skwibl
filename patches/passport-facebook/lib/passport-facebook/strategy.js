...
Strategy.prototype.userProfile = function(accessToken, done) {
  this._oauth2.getProtectedResource('https://graph.facebook.com/me?fields=picture,id,name,username,first_name,last_name,middle_name,gender,link,email', accessToken, function (err, body, res) {
